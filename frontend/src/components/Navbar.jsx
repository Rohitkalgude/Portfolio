...
//   return (
//     <nav className="fixed top-0 left-0 w-full z-50 px-7 sm:px-13 py-4 sm:py-6 backdrop-blur-sm bg-transparent text-gray-300 text-lg sm:text-xl">
//       <div className="flex justify-between items-center max-w-7xl mx-auto">
//         {/* Title */}
//         <div className="flex-shrink-0 -ml-4 sm:-ml-28">
//           <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-[#a855f7] to-[#6366f1] bg-clip-text text-transparent drop-shadow-lg">
//             Rohit Kalgude
//           </h1>
//         </div>
...
//         {/* Desktop Nav Links */}
//         <div className="text-base hidden sm:flex space-x-12 -mr-24">
//           {/* Home */}
...
//       {/* Mobile Nav Links */}
//       {open && (
//         <div className="flex flex-col items-center sm:hidden gap-8 mt-6">
//           <Link
//             to="home"
//             smooth={true}
//             duration={500}
