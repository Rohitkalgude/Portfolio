...
import {
  ...
  SiMongodb,
  SiTailwindcss,
} from "react-icons/si"; // 👈 Added Tailwind icon
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8">
          {tech.map(({ name, icon: Icon, color }, index) => (
            <motion.div
              ...
              className="flex flex-col items-center justify-center p-6 bg-[#1e1e2f] rounded-2xl shadow-lg border border-white/10 transition-all hover:shadow-purple-500/30"
            >
              <motion.div
                animate={
                  name === "React"
